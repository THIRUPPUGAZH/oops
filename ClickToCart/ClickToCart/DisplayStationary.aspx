<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisplayStationary.aspx.cs" Inherits="ClickToCart.DisplayStationary" %>
...
<body>
    <form id="form1" runat="server">
           <div>
            <asp:DataList ID="D1" runat="server" RepeatColumns="5" >
                <ItemTemplate>
                <table>
                    <tr>
